...
public class NewJFrame extends javax.swing.JFrame {
    ...
    public void showTable() {
        for(Student sv: listSV) {
            ...
            i++, sv.getId(), sv.getName(), sv.getAddress(), sv.getEmail(), sv.getPhone(),
            sv.getDob(), sv.getMark()
        });
        }
    }
    ...
    private void initComponents() {
        ...
        jToggleButton2.setText("Reset Form");
        ...
        table1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "ID", "Name", "Address", "Email", "Phone", "DoB", "Mark"
            }
        ));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtMark, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        sv.setMark(Float.parseFloat(txtMark.getText()));
        System.out.println(sv.toString());
        listSV.add(sv);
        if(new DAO().add(sv)){
            JOptionPane.showMessageDialog(rootPane, "Da luu thanh cong!");
        }else {
            JOptionPane.showMessageDialog(rootPane, "Ktra lai thong tin nhap!");
        }
        showResult();
    }//GEN-LAST:event_btnAddActionPerformed
    int i = 1;
    public void showResult() {
        Student sv = listSV.get(listSV.size() - 1);
        model.addRow(new Object[]{
            i++, sv.getId(), sv.getName(), sv.getAddress(), sv.getEmail(), sv.getPhone(),
            sv.getDob(), sv.getMark()
        });
